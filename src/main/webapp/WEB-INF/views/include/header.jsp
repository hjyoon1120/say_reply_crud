...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.html" class="logo">
            ...
            <span class="logo-mini"><b>ㄷ</b></span>
            ...
            <div class="navbar-custom-menu" style="float:left">
                ...
                <ul class="nav navbar-nav" style="text-align: center">
                    ...
                    <li class="dropdown notifications-menu">
                        <a href="http://localhost:8083/towntalk/say.html">
                            <i class="glyphicon glyphicon-list-alt"></i>
                        </a>

                    </li>
                    <li class="dropdown notifications-menu">
                        <a href="http://localhost:8083/towntalk/plaza.html">
                            <i class="glyphicon glyphicon-th-large"></i>
                        </a>

                    </li>
                    <li class="dropdown tasks-menu">
                        <a href="http://localhost:8083/towntalk/party.html">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div><hr color="lightgrey"></div>
            <p style="color:lightgrey; text-align: center">
            <b>Version</b> 0.0.0
            <strong>Copyright &copy; 2016 <br><a href="http://monsgroup.com">MONs group</a>.</strong> All rights
                reserved.
            </p>
