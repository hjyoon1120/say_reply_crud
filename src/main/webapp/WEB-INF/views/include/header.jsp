...
<title>Towntalk | MONs group</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>ㄷ</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Town</b>talk</span>
			</a>
			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu" style="float: left">
					...
					<ul class="nav navbar-nav" style="text-align: center">
                        ...
                        <a href="http://localhost:8083/towntalk/index.html">
                            <i class="fa fa-heartbeat"></i>
                        </a>

                    </li>-->
						<li class="dropdown notifications-menu"><a
							href="http://localhost:8083/towntalk/say.html"> <i
								class="glyphicon glyphicon-list-alt"></i>
						</a></li>
						<li class="dropdown notifications-menu"><a
							href="http://localhost:8083/towntalk/plaza.html"> <i
								class="glyphicon glyphicon-th-large"></i>
						</a></li>
						<li class="dropdown tasks-menu"><a
							href="http://localhost:8083/towntalk/party.html"> <i
								class="fa fa-users"></i>
						</a></li>
					</ul>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<li class="header">TOWN TALK</li>
					<li class="active treeview"><a href="#"> <i
							class="fa fa-home"></i> <span>MY HOMETOWN</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-commenting-o"></i> <span>MESSAGES</span>
					</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-heart"></i>
							<span>FOLLOWER</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-user-secret"></i> <span>TRACING</span>
					</a></li>

					<li class="header">ITEMS</li>

					<li class="treeview"><a href="#"> <i class="fa fa-krw"></i>
							<span>MON STORE</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-shopping-cart"></i> <span>ITEM STORE</span>
					</a></li>
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-info-circle"></i> <span>INFORMATIONS</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
				...
				<p style="color: lightgrey; text-align: center">
					<b>Version</b> 0.0.0 <strong>Copyright &copy; 2016 <br>
						<a href="http://monsgroup.com">MONs group</a>.
